...
singleWordFrequency(textfile, 'singlewordfreq_irish')

multiWordFrequency(textfile, 3, 'multiwordfreq_n3_irish')

multiWordFrequency(textfile, 2, 'multiwordfreq_n2_irish')
